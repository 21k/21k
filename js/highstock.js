...
(function() {
 ...
 na.prototype = {
  ...
  init: function(a, b, c, d, e) {
   ...
   this.createElement("desc").add().element.appendChild(E.createTextNode("By QutKe.Com"));
 ...
 Pa.prototype = {
  ...
  showCredits: function(a) {
   if (a.enabled && !this.credits) {
       this.credits = this.renderer.text(a.text, 0, 0).css(a.style).add().align(a.position).attr("title", a.href).attr({
           align: a.position.align,
           zIndex: 8
       }).on("click",
           function () {
               if (a.href) window.open(this.children[0].innerHTML)
           })
 ...
 Fb.prototype = {
  ...
  setInputValue: function(a, b) {
   ...
   this[a + "DateBox"].attr({
    text: ka(c.inputDateFormat || "%Y-%b-%e", this[a + "Input"].HCTime)
   })
  },
